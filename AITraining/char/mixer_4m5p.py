...
plt.savefig('/home/iot/jupyter/root_dir/liudongdong/src/ai/char/output/confusion/{}.png'.format('mixer_4m5p'), format='png',dpi=400,bbox_inches='tight',pad_inches = -0.1)
