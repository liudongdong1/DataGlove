...
mlp_mixer.load_state_dict(torch.load('./output/CharConfig5Point/weights-4-21868-[0.8031].pth'))
...
def plot_Matrix(cm, classes, title=None,  cmap=plt.cm.Blues):
    ...
    fig.tight_layout()
    plt.savefig('./mixer_2m5pV2.png', dpi=300)
    plt.show()

cm = confusion_matrix(ALLlabels,ALLpreds)
ALLpreds=np.column_stack((ALLlabels,ALLpreds))
np.savetxt("2m5p.txt", ALLpreds,fmt='%d',delimiter=',')
#print(cm)
labels_name={'a','b','c','d','e','f','g','h','i','j','k','l','m','n','o','p','q','r','s','t','u','v','w','x','y','z'}
plot_confusion_matrix(cm, labels_name,"")
plt.savefig('/home/iot/jupyter/root_dir/liudongdong/src/ai/char/output/confusion/{}.png'.format('mixer_2m5p'), format='png')
