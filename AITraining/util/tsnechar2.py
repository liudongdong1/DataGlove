...
dataloader={}
dataloader['train'] = DataLoader(dataset=data_set['train'], batch_size=26*10000, shuffle=True)
dataloader['val'] = DataLoader(dataset=data_set['val'], batch_size=26*10000, shuffle=True)
...
cbar.set_label(label='char value', fontdict=font)
