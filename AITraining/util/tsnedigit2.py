...
dataloader={}
dataloader['train'] = DataLoader(dataset=data_set['train'], batch_size=10*10000, shuffle=True)
dataloader['val'] = DataLoader(dataset=data_set['val'], batch_size=10*10000, shuffle=True)
